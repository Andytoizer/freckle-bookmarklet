...
export const PLAYS: Play[] = [
  ...
  {
    id: 'email',
    where: 'Add this as a branch for each source I kept',
    marks: [LI, SN, SF, HS],
    title: 'Find a contact\u2019s email',
    send: 'Your pick of LinkedIn, Sales Navigator, Salesforce or HubSpot',
    get: 'A verified work email',
    prompt: `Use Freckle to find and verify a work email for the contact from a [LinkedIn profile / Sales Navigator lead / Salesforce record / HubSpot record: keep the ones you use]. Write it to the row, and to the CRM record if that's where the contact came from, without overwriting a value that's already there.`,
  },
  {
    id: 'mobile',
    where: 'Add this as a branch for each source I kept',
    ...
    send: 'Your pick of LinkedIn, Sales Navigator, Salesforce or HubSpot',
    get: 'A mobile number',
    prompt: `Use Freckle to find a mobile phone number for the contact from a [LinkedIn profile / Sales Navigator lead / Salesforce record / HubSpot record: keep the ones you use]. Write it to the row, and to the CRM record if that's where the contact came from, without overwriting a value that's already there.`,
  },
  {
    id: 'email-mobile',
    where: 'Add this as a branch for each source I kept',
    ...
    prompt: `Use Freckle to find and verify a work email and find a mobile phone number for the contact from a [LinkedIn profile / Sales Navigator lead / Salesforce record / HubSpot record: keep the ones you use]. Write both to the row, and to the CRM record if that's where the contact came from, without overwriting values that are already there.`,
  },
  {
    id: 'enroll',
    where: 'Add this as a branch for each source I kept',
    ...
    prompt: `Use Freckle to enroll the contact from a [LinkedIn profile / Sales Navigator lead / Salesforce record / HubSpot record: keep the ones you use] in the [Instantly / HeyReach / Lemlist: pick one] sequence called [sequence name]. Find and verify a work email first if the tool needs one. Write the tool, the sequence and the enrollment status to the row. If I haven't replaced the bracketed choices, ask me before you build anything.`,
  },
  {
    id: 'icp-contacts',
